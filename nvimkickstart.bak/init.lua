...
-- See `:help mapleader`
--  NOTE: Must happen before plugins are loaded (otherwise wrong leader will be used)-- Prepend Volta's bin directory to PATH
vim.env.PATH = os.getenv 'HOME' .. '/.volta/bin:' .. vim.env.PATH
vim.g.mapleader = ' '
...
require('lazy').setup({
  ...
  --   -- i can't get this to work omegalul
  --   config = function()
  ...
  --     -- can probably delete, we init it outside of treesitter now
